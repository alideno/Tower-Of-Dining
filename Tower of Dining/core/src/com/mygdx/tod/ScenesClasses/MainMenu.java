...
public class MainMenu extends ScreenAdapter {
    ...
    public MainMenu(TowerOfDining tod) {
        ...
        // Creating the "Settings" button textures are not necessary since the button
        // will be invisible
        ...
        // Creating the "LeaderBoard" button textures are not necessary since the button
        // will be invisible
        ...
        TextureRegionDrawable upDrawableExit = new TextureRegionDrawable(
                new TextureRegion(new Texture("exitButton.png")));// Change the image
